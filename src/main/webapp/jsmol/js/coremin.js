...
Clazz_declarePackage ("J.minimize.forcefield");
Clazz_load (["J.minimize.forcefield.Calculation", "JU.AU", "$.SB", "$.V3d"], "J.minimize.forcefield.Calculations", ["java.lang.Float", "J.minimize.Util", "JW.Txt"], function () {
c$ = Clazz_decorateAsClass (function () {
this.ff = null;
...
Clazz_declarePackage ("J.minimize.forcefield");
Clazz_load (["J.minimize.forcefield.Calculation", "$.Calculations"], "J.minimize.forcefield.CalculationsMMFF", ["JU.List", "J.minimize.MinAtom", "$.MinObject", "JW.Txt"], function () {
c$ = Clazz_decorateAsClass (function () {
this.ffParams = null;
this.bondCalc = null;
this.angleCalc = null;
