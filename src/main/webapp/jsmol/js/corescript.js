...
Clazz_declarePackage ("J.script");
Clazz_load (["J.script.ScriptParam"], "J.script.ScriptExpr", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "$.Map", "JU.BS", "$.CU", "$.List", "$.M34", "$.M4", "$.P3", "$.P4", "$.PT", "$.SB", "J.api.Interface", "JM.Atom", "$.BondSet", "$.Group", "$.ModelCollection", "J.script.SV", "$.ScriptContext", "$.ScriptMathProcessor", "$.T", "JW.BSUtil", "$.Elements", "$.Escape", "$.Logger", "$.Measure", "$.Txt"], function () {
c$ = Clazz_decorateAsClass (function () {
...
filename = this.paramAsStr (1);
if (filename.equalsIgnoreCase ("applet")) {
var appID = this.paramAsStr (2);
...
Clazz_declarePackage ("J.script");
Clazz_load (["J.api.JmolScriptManager", "JU.List"], "J.script.ScriptManager", ["java.io.BufferedReader", "java.lang.Boolean", "$.Thread", "javajs.api.ZInputStream", "JU.BS", "$.PT", "$.SB", "J.api.Interface", "J.io.JmolBinary", "J.script.ScriptQueueThread", "JW.Elements", "$.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
this.viewer = null;
this.eval = null;
this.evalTemp = null;
...
Clazz_superConstructor (this, J.script.ScriptInterruption, [eval, why, "!", millis == -2147483648 || eval.viewer.autoExit]);
...
case 10:
return this.addXBs (JW.BSUtil.copyInvert (J.script.SV.bsSelectVar (x2), (Clazz_instanceOf (x2.value, JM.BondSet) ? this.viewer.getBondCount () : this.viewer.getAtomCount ())));
}
