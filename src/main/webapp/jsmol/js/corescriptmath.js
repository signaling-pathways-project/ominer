...
var bs = (Clazz_instanceOf (args[0].value, JU.BS) ? args[0].value : this.viewer.getAtomBits (1095761939,  new Integer (args[0].asInt ())));
switch (tok) {
case 135266320:
