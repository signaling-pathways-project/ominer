...
Clazz.load (["JSV.api.SourceReader", "JU.SB"], "JSV.source.XMLReader", ["java.io.IOException", "JU.List", "JSV.common.Coordinate", "$.JDXSpectrum", "JSV.source.JDXReader", "$.JSVXmlReader", "JW.Logger"], function () {
