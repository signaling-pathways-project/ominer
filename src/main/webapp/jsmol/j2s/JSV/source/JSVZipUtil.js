...
Clazz.load (["JSV.api.JSVZipInterface"], "JSV.source.JSVZipUtil", ["java.io.BufferedInputStream", "$.ByteArrayInputStream", "java.util.zip.GZIPInputStream", "$.ZipInputStream", "JU.AU", "$.List", "$.SB", "JSV.common.JSViewer", "JW.Logger"], function () {
