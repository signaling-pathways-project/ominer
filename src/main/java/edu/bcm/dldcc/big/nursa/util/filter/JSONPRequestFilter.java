 ...
 * </p>
 * <p>
 * To qualify for wrapping the request must be made to the <i>/rest/api/*</i> path, and contain a query parameter call
 * <i>callback</> that defines the JSONP callback method to use with the response.
 * </p>
 * 
 * @author mcowiti
 * @author balunasj
...
@WebFilter(filterName = "ApiJsonpFilter", urlPatterns = { "/api/*","/rest/api/*","/rest/pharmgkb/data/*"}, dispatcherTypes = { DispatcherType.REQUEST })
